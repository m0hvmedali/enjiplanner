...
export const Logo: React.FC<LogoProps> = ({ className = "w-8 h-8" }) => {
    return (
        ...
        >
            <defs>
                {/* تدرج سينمائي (Cinematic Cyan/Blue) */}
                <linearGradient id="softCyan" x1="0%" y1="100%" x2="100%" y2="0%">
            ...
            {/* السلم (المثابرة) */}
            <g stroke="url(#softCyan)" strokeWidth="12" strokeLinecap="round">
                {/* قوائم السلم */}
            ...
            <g className="star-bright">
                ...
                <circle cx="380" cy="80" r="55" fill="none" stroke="#7dd3fc" strokeWidth="2" strokeDasharray="4 8" opacity="0.5" />
            </g>

            {/* الشخصان (الرفقة) */}
            <g className="climber-1">
                <circle cx="210" cy="315" r="12" fill="#7dd3fc" />
                <path d="M 210 327 Q 210 350 190 360" stroke="#7dd3fc" strokeWidth="8" fill="none" strokeLinecap="round" />
            </g>

            <g className="climber-2">
                <circle cx="260" cy="225" r="12" fill="#0ea5e9" />
                <path d="M 260 237 Q 260 260 240 270" stroke="#0ea5e9" strokeWidth="8" fill="none" strokeLinecap="round" />
            </g>
            ...
            <text
                ...
                y="490"
                textAnchor="middle"
                className="fill-sky-500 font-medium text-xl tracking-widest"
